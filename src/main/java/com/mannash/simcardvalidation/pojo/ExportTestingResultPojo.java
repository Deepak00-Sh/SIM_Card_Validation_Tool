...
public class ExportTestingResultPojo implements Serializable {
    ...
    public String toString() {
        return "requestSimVerificationCardPojos{" +
                "dateOfTesting='" + dateOfTesting + '\'' +
                ", timeOfTesting='" + timeOfTesting + '\'' +
                ", userName='" + userName + '\'' +
                ", terminalNumber=" + terminalNumber +
                ", terminalICCID='" + terminalICCID + '\'' +
                ", terminalIMSI='" + terminalIMSI + '\'' +
                ", simHeartbeat='" + simHeartbeat + '\'' +
                ", fileSystemVerification='" + fileSystemVerification + '\'' +
                ", profileTesting='" + profileTesting + '\'' +
                ", readWrite='" + readWrite + '\'' +
