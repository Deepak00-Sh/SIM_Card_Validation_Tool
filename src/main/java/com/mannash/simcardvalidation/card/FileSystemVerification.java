...
public class FileSystemVerification {
	...
	public FileSystemVerification(String aDM, TerminalInfo terminal, Card c, LoggerService loggerService, TestingController4 testingController4) {
		this.aDM = aDM;
...
//				// System.out.println("Sorry, unable to find config.properties"); 
	...
	public boolean runProfileTesting() {
		...
		if (this.aDM.equals("0000000000000000")) {
			this.aID = getAID();
			if (this.aID == null) {
				controller.displayLogs(_card,_terminal,"Card AID not found");
				return false;
			}
			// this.logger.debug("\nAID OF THE CARD
			// ....................................................." + this.aID);
			...
			this.ICCID = getICCID();
			if (this.ICCID == null) {
				controller.displayLogs(_card,_terminal,"Card ICCID not found");
				return false;
			}
		...
		try {
			...
			while (filesystemConfigs.hasNext()) {
				...
				if (arrayOfString[0].equals("RESET")) {
					controller.displayLogs(_terminal,_card,"RESET");
					if (!resetChannel()) {
						return false;
					}
				}
