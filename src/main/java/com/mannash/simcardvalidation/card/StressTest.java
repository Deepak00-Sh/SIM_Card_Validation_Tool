...
public class StressTest {
	...
	TestingController4 controller ;

	public StressTest(TerminalInfo terminal, Card c, LoggerService loggerService,TestingController4 testingController4) {
...
//					controller.displayLogs(_card,_terminal,paramString+"ERROR: nibble is missing in APDU");
				} else {
...
//							controller.displayLogs(_card,_terminal,paramString+"ERROR: Invalid Hex Value in the APDU");
							bool = false;
							break;
						}
					}
...
//							controller.displayLogs(_card,_terminal,paramString+"ERROR: " + exception.getMessage());
						}
						try {
...
//							controller.displayLogs(_card,_terminal,"ERROR: Invalid APDU");
						}
					}
				}
		} catch (CardException cardException) {
